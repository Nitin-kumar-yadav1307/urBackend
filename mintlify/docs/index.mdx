...
<img
  src="https://cdn.jsdelivr.net/gh/geturbackend/urBackend@main/banner.png"
  alt="urBackend banner"
  className="w-full rounded-xl mb-8"
/>

<h1 className="text-4xl font-medium tracking-tight text-gray-900 dark:text-zinc-50">
  urBackend Documentation
</h1>

<p className="mt-2 mb-8 text-lg text-gray-500 dark:text-zinc-400">
